...
--
-- Table structure for table `PessoaAbstract`
--

DROP TABLE IF EXISTS `PessoaAbstract`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `PessoaAbstract` (
  ...
  `pontoReferencia` varchar(200) DEFAULT NULL,
...
--
-- Dumping data for table `PessoaAbstract`
--

LOCK TABLES `PessoaAbstract` WRITE;
/*!40000 ALTER TABLE `PessoaAbstract` DISABLE KEYS */;
/*!40000 ALTER TABLE `PessoaAbstract` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `PessoaFisica` (
  ...
  CONSTRAINT `PessoaFisica_ibfk_1` FOREIGN KEY (`id`) REFERENCES `PessoaAbstract` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PessoaJuridica` (
  ...
  KEY `idx_cnpj` (`cnpj`),
  KEY `idx_atualizado_em` (`atualizado_em`),
  CONSTRAINT `PessoaJuridica_ibfk_1` FOREIGN KEY (`id`) REFERENCES `PessoaAbstract` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-02 20:57:50
